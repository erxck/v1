...
import { IconTypeScript, IconFirebase, IconReact, IconTailwind } from "./icons";
...
export default function Main({ projects }: any): JSX.Element {
  ...
  return (
    <main className="px-6 py-16 w-full max-w-[1440px] mx-auto sm:px-16 lg:px-24 xl:px-36">
      {/* About */}
      <About />
